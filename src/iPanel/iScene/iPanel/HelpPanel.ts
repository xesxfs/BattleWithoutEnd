module iPanel {
	export module iScene {
		// export module iPanel {
			export class HelpPanel extends iPanel.iCell.BasicCell {
				...
				private init():any
				{
					...
					var title:iPanel.iCell.StringCell = new iPanel.iCell.StringCell("帮助",200,36);
					this.addChild(title);
					title.x = 230;
					title.y = 10;
					...
					_this = this;
					var text:flash.TextField = iGlobal.Global.getTextField(20);
					text.width = 500;
					text.x = 25;
					text.y = 50;
					text.multiline = true;
...
// flash.extendsClass("iPanel.iScene.iPanel.HelpPanel","iPanel.iCell.BasicCell")
