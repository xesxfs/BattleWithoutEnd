module iPanel {
	export module iScene {
		export module iPanel {
			export class PlayerInfoPanel extends iPanel.iCell.BasicCell {
				...
				private race:iPanel.iCell.StringCell;
				private age:iPanel.iCell.StringInfoCell;
				private lv:iPanel.iCell.StringCell;
				private hp:iPanel.iBar.Bar;
				private mp:iPanel.iBar.Bar;
				private exp:iPanel.iBar.Bar;
				private gold:iPanel.iCell.StringCell;
				private str:iPanel.iCell.StringCell;
				private dex:iPanel.iCell.StringCell;
				private intelligence:iPanel.iCell.StringCell;
				private will:iPanel.iCell.StringCell;
				private luck:iPanel.iCell.StringCell;
				private ap:iPanel.iCell.StringCell;
				private attack:iPanel.iCell.StringCell;
				private balance:iPanel.iCell.StringCell;
				private crit:iPanel.iCell.StringCell;
				private defence:iPanel.iCell.StringCell;
				private protection:iPanel.iCell.StringInfoCell;
				private pro_ignore:iPanel.iCell.StringCell;
				private crit_mul:iPanel.iCell.StringCell;
				...
				{
					var _loc1_:iPanel.iCell.StringCell = new iPanel.iCell.StringCell("名字");
					...
					var _loc2_:Array<any> = new Array();
					var _loc3_:iPanel.iCell.StringCell = new iPanel.iCell.StringCell("种族");
					_loc2_.push(_loc3_);
					this.race = new iPanel.iCell.StringCell(iGlobal.Player.race.name.toUpperCase());
					_loc2_.push(this.race);
					var _loc4_:iPanel.iCell.StringCell = new iPanel.iCell.StringCell("年龄");
					_loc2_.push(_loc4_);
					this.age = new iPanel.iCell.StringInfoCell("17","还剩:");
					_loc2_.push(this.age);
					var _loc5_:iPanel.iCell.StringCell = new iPanel.iCell.StringCell("LV");
					_loc2_.push(_loc5_);
					...
					var _loc6_:number = flash.checkInt(_loc2_.length);
				...
				public upDate():any
				{
					...
					var _loc1_:string = "";
					var _loc2_:iData.Race = iGlobal.Player.race;
					var _loc3_:number = flash.checkInt(iGlobal.Player.age);
					var _loc4_:number = flash.checkInt(17 - _loc3_);
				...
				{
					var _loc1_:number = flash.checkInt(iGlobal.Player.caculate % 2400);
