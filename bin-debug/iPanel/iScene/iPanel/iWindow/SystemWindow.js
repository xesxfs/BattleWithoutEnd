            ...
            (function (iWindow) {
                var SystemWindow = (function (_super) {
                    ...
                    SystemWindow.prototype.setToggle = function () {
                        ...
                        var text = new iPanel.iCell.StringCell("日志显示", 150, this.fontSize_big);
                        this.addChild(text);
                        text.x = 5;
                        text.y = 10;
                        var battle = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("战况", this.fontSize_small, iGlobal.Global.battle_toggle);
                        this.addChild(battle);
                        battle.x = 10;
                        battle.y = 60;
                        battle.downFunction = battleDown;
                        battle.upFunction = battleUp;
                        var battleIntro = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("战果", this.fontSize_small, iGlobal.Global.battleIntro_toggle);
                        this.addChild(battleIntro);
                        battleIntro.x = 70;
                        battleIntro.y = 60;
                        battleIntro.downFunction = battleIntroDown;
                        battleIntro.upFunction = battleIntroUp;
                        var money = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("$", this.fontSize_small, iGlobal.Global.money_toggle);
                        this.addChild(money);
                        money.x = 140;
                        money.y = 60;
                        money.downFunction = moneyDown;
                        money.upFunction = moneyUp;
                        var exp = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("Exp", this.fontSize_small, iGlobal.Global.exp_toggle);
                        this.addChild(exp);
                        exp.x = 10;
                        exp.y = 90;
                        exp.downFunction = expDown;
                        exp.upFunction = expUp;
                        var item = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("道具", this.fontSize_small, iGlobal.Global.item_toggle);
                        this.addChild(item);
                        item.x = 70;
                        item.y = 90;
                    ...
                    SystemWindow.prototype.setItemToggle = function () {
                        ...
                        var text = new iPanel.iCell.StringCell("道具拾取", 150, this.fontSize_big);
                        this.addChild(text);
                        text.x = 5;
                        text.y = this.lootStartY;
                        var item0 = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("基础", this.fontSize_small, iGlobal.Global.item0_toggle);
                        this.addChild(item0);
                        item0.x = this.lootStartX;
                        item0.y = this.lootStartY + this.lootGapMidY * 1;
                        item0.downFunction = item0Down;
                        item0.upFunction = item0Up;
                        var item1 = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("<font color=\'" + iData.iItem.Equipment.GREEN + "\'>精品</font>", this.fontSize_small, iGlobal.Global.item1_toggle);
                        this.addChild(item1);
                        ...
                        var item2 = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("<font color=\'" + iData.iItem.Equipment.BLUE + "\'>稀有</font>", this.fontSize_small, iGlobal.Global.item2_toggle);
                        this.addChild(item2);
                        ...
                        var item3 = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("<font color=\'" + iData.iItem.Equipment.YELLOW + "\'>完美</font>", this.fontSize_small, iGlobal.Global.item3_toggle);
                        this.addChild(item3);
                        ...
                        var item4 = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("<font color=\'" + iData.iItem.Equipment.ORANGE + "\'>史诗</font>", this.fontSize_small, iGlobal.Global.item4_toggle);
                        this.addChild(item4);
                        ...
                        var item5 = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("<font color=\'" + iData.iItem.Equipment.PURPLE + "\'>传奇</font>", this.fontSize_small, iGlobal.Global.item5_toggle);
                        this.addChild(item5);
                    ...
                    SystemWindow.prototype.setWeaponToggle = function () {
                        ...
                        var text = new iPanel.iCell.StringCell("武器拾取", 150, 20);
                        this.addChild(text);
                        text.x = this.lootStartX + this.lootGapX * 0;
                        text.y = this.lootStartY + this.lootGapMidY * 1 + this.lootGapSmallY * 1 + this.lootGapY * 1;
                        var sword = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("剑", this.fontSize_small, iGlobal.Global.sword_toggle);
                        this.addChild(sword);
                        ...
                        var axe = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("斧", this.fontSize_small, iGlobal.Global.axe_toggle);
                        this.addChild(axe);
                        ...
                        var bow = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("弓", this.fontSize_small, iGlobal.Global.bow_toggle);
                        this.addChild(bow);
                        ...
                        var crossbow = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("弩", this.fontSize_small, iGlobal.Global.crossbow_toggle);
                        ...
                        var sceptre = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("权杖", this.fontSize_small, iGlobal.Global.sceptre_toggle);
                        ...
                        var staff = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("法杖", this.fontSize_small, iGlobal.Global.staff_toggle);
                        this.addChild(staff);
                    ...
                    SystemWindow.prototype.setOffhand = function () {
                        ...
                        var text = new iPanel.iCell.StringCell("副手拾取", 150, 20);
                        this.addChild(text);
                        text.x = this.lootStartX + this.lootGapX * 0;
                        text.y = this.lootStartY + this.lootGapMidY * 1 + this.lootGapSmallY * 2 + this.lootGapY * 3;
                        var dagger = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("匕首", this.fontSize_small, iGlobal.Global.dagger_toggle);
                        ...
                        var tome = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("书", this.fontSize_small, iGlobal.Global.tome_toggle);
                        this.addChild(tome);
                        ...
                        var shield = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("盾", this.fontSize_small, iGlobal.Global.shield_toggle);
                    ...
                    SystemWindow.prototype.setHead = function () {
                        ...
                        var text = new iPanel.iCell.StringCell("头部拾取", 150, 20);
                        this.addChild(text);
                        text.x = this.lootStartX + this.lootGapX * 0;
                        text.y = this.lootStartY + this.lootGapMidY * 1 + this.lootGapSmallY * 3 + this.lootGapY * 4;
                        var headLight = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("轻甲", this.fontSize_small, iGlobal.Global.head_light_toggle);
                        ...
                        var headMedium = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("中甲", this.fontSize_small, iGlobal.Global.head_medium_toggle);
                        ...
                        var headHeavy = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("重甲", this.fontSize_small, iGlobal.Global.head_heavy_toggle);
                    ...
                    SystemWindow.prototype.setBody = function () {
                        ...
                        var text = new iPanel.iCell.StringCell("身体拾取", 150, 20);
                        this.addChild(text);
                        text.x = this.lootStartX + this.lootGapX * 0;
                        text.y = this.lootStartY + this.lootGapMidY * 1 + this.lootGapSmallY * 4 + this.lootGapY * 5;
                        var bodyLight = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("轻甲", this.fontSize_small, iGlobal.Global.body_light_toggle);
                        ...
                        var bodyMedium = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("中甲", this.fontSize_small, iGlobal.Global.body_medium_toggle);
                        ...
                        var bodyHeavy = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("重甲", this.fontSize_small, iGlobal.Global.body_heavy_toggle);
                    ...
                    SystemWindow.prototype.setFeet = function () {
                        ...
                        var text = new iPanel.iCell.StringCell("足部拾取", 150, 20);
                        this.addChild(text);
                        text.x = this.lootStartX + this.lootGapX * 0;
                        text.y = this.lootStartY + this.lootGapMidY * 1 + this.lootGapSmallY * 5 + this.lootGapY * 6;
                        var feetLight = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("轻甲", this.fontSize_small, iGlobal.Global.feet_light_toggle);
                        ...
                        var feetMedium = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("中甲", this.fontSize_small, iGlobal.Global.feet_medium_toggle);
                        ...
                        var feetHeavy = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("重甲", this.fontSize_small, iGlobal.Global.feet_heavy_toggle);
                    ...
                    SystemWindow.prototype.setAccessory = function () {
                        ...
                        var text = new iPanel.iCell.StringCell("饰品拾取", 150, 20);
                        this.addChild(text);
                        text.x = this.lootStartX + this.lootGapX * 0;
                        text.y = this.lootStartY + this.lootGapMidY * 1 + this.lootGapSmallY * 6 + this.lootGapY * 7;
                        var ring = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("戒指", this.fontSize_small, iGlobal.Global.ring_toggle);
                        this.addChild(ring);
                        ...
                        var necklace = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("项链", this.fontSize_small, iGlobal.Global.necklace_toggle);
                    ...
                    SystemWindow.prototype.autoSell = function () {
                        ...
                        var autoSell = new iPanel.iScene.iPanel.iWindow.iSystem.ToggleBox("Auto sell lowest value while bag is full", this.fontSize_small, iGlobal.Global.autoSell_toggle);
                ...
                iWindow.SystemWindow = SystemWindow;
                __reflect(SystemWindow.prototype, "iPanel.iScene.iPanel.iWindow.SystemWindow");
...
//# sourceMappingURL=SystemWindow.js.map