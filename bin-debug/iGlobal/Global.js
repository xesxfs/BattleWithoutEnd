...
(function (iGlobal) {
    var Global = (function () {
        ...
        Global.getTextField = function (param1, param2) {
            if (param1 === void 0) { param1 = 16; }
            if (param2 === void 0) { param2 = 7631988; }
            // var _loc3_:flash.TextFormat = new flash.TextFormat("RTWS YueGothic Trial Regular",param1,param2);
            var _loc4_ = new egret.TextField();
