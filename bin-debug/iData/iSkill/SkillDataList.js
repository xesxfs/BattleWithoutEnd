    ...
    (function (iSkill) {
        var SkillDataList = (function () {
            ...
            SkillDataList.behave_smash = function (param1) {
                ...
                iPanel.iScene.MainScene.battle.monsterHp = iPanel.iScene.MainScene.battle.monsterHp - _loc4_;
            ...
            SkillDataList.behave_life_drain = function (param1) {
                //这里
                var _loc2_ = param1.skillData.setList;
                if (iPanel.iScene.MainScene.battle.playerMp < _loc2_[param1.level][0]) {
                    return false;
                }
                iPanel.iScene.MainScene.battle.playerMp = iPanel.iScene.MainScene.battle.playerMp - _loc2_[param1.level][0];
                var _loc3_ = iData.iSkill.SkillDataList.getCritMul();
                var _loc4_ = (iGlobal.Player.attack * _loc3_ * (1 + _loc2_[param1.level][1] * iGlobal.Player.str) - iData.iSkill.SkillDataList.monster.defence) * iData.iSkill.SkillDataList.monsterPro;
                if (_loc4_ < 1) {
                    _loc4_ = 1;
                }
                iPanel.iScene.MainScene.battle.monsterHp = iPanel.iScene.MainScene.battle.monsterHp - _loc4_;
                var _loc5_ = _loc4_ * _loc2_[param1.level][2] / 100;
                if (iGlobal.Player.hp - iPanel.iScene.MainScene.battle.playerHp < _loc5_) {
                    _loc5_ = iGlobal.Player.hp - iPanel.iScene.MainScene.battle.playerHp;
                }
                iPanel.iScene.MainScene.battle.playerHp = iPanel.iScene.MainScene.battle.playerHp + _loc5_;
                iData.iSkill.SkillDataList.traceAttackInfo(param1.skillData.realName, _loc4_, _loc3_);
                iPanel.iScene.MainScene.allInfoPanel.addText("你回复了 <font color=\'" + iData.iItem.Equipment.GREEN + "\'>" + _loc5_ + " hp!</font>", iGlobal.Global.battle);
                return true;
            };
            SkillDataList.behave_defence = function (param1) {
                ...
                iPanel.iScene.MainScene.battle.playerHp = iPanel.iScene.MainScene.battle.playerHp - _loc5_;
                if (_loc4_ > 1) {
                    iPanel.iScene.MainScene.allInfoPanel.addText("你<font color=\'#ff4040\'>防御</font>成功, " + iData.iSkill.SkillDataList.monster.nameHtml + "对你造成<font color=\'#ff4040\' size=\'20\'>" + _loc5_ + "!</font>伤害", iGlobal.Global.battle);
                }
                else {
                    iPanel.iScene.MainScene.allInfoPanel.addText("你<font color=\'#ff4040\'>防御</font>成功, " + iData.iSkill.SkillDataList.monster.nameHtml + "对你造成<font color=\'#ff4040\'>" + _loc5_ + "</font>伤害", iGlobal.Global.battle);
                }
            ...
            SkillDataList.behave_mana_shield = function (param1) {
                ...
                iPanel.iScene.MainScene.battle.playerMp = iPanel.iScene.MainScene.battle.playerMp - _loc7_;
                if (_loc4_ > 1) {
                    iPanel.iScene.MainScene.allInfoPanel.addText(iData.iSkill.SkillDataList.monster.nameHtml + "对你造成<font color=\'#ff4040\' size=\'20\'>" + _loc5_ + "!</font>伤害," + "<font color=\'#ff4040\'>魔法盾</font>吸收<font color=\'#ff4040\'>" + _loc6_ + "</font>", iGlobal.Global.battle);
                }
                else {
                    iPanel.iScene.MainScene.allInfoPanel.addText(iData.iSkill.SkillDataList.monster.nameHtml + "对你造成<font color=\'#ff4040\'>" + _loc5_ + "</font>伤害," + "<font color=\'#ff4040\'>魔法盾</font>吸收<font color=\'#ff4040\'>" + _loc6_ + "</font>", iGlobal.Global.battle);
                }
                iData.iPlayer.TitleList.updateTitleInfo("endure", _loc5_);
                return true;
            };
            SkillDataList.behave_counterattack = function (param1) {
                ...
                iPanel.iScene.MainScene.battle.playerHp = iPanel.iScene.MainScene.battle.playerHp - _loc5_;
                if (_loc4_ > 1) {
                    iPanel.iScene.MainScene.allInfoPanel.addText(iData.iSkill.SkillDataList.monster.nameHtml + "对你造成<font color=\'#ff4040\' size=\'20\'>" + _loc5_ + "!</font>伤害", iGlobal.Global.battle);
                }
                else {
                    iPanel.iScene.MainScene.allInfoPanel.addText(iData.iSkill.SkillDataList.monster.nameHtml + "对你造成<font color=\'#ff4040\'>" + _loc5_ + "</font>伤害", iGlobal.Global.battle);
                }
                iData.iPlayer.TitleList.updateTitleInfo("endure", _loc5_);
                if (iPanel.iScene.MainScene.battle.playerHp < 0) {
                    return true;
                }
                ...
                iPanel.iScene.MainScene.battle.monsterHp = iPanel.iScene.MainScene.battle.monsterHp - _loc6_;
                if (_loc4_ > 1) {
                    iPanel.iScene.MainScene.allInfoPanel.addText("你<font color=\'#ff4040\'>反击</font>成功,对" + iData.iSkill.SkillDataList.monster.nameHtml + "造成<font color=\'#ff4040\' size=\'20\'>" + _loc6_ + "!</font>伤害", iGlobal.Global.battle);
                    iData.iPlayer.TitleList.updateTitleInfo("crit", 0, 1);
                }
                else {
                    iPanel.iScene.MainScene.allInfoPanel.addText("你<font color=\'#ff4040\'>反击</font>成功,对" + iData.iSkill.SkillDataList.monster.nameHtml + "造成<font color=\'#ff4040\'>" + _loc6_ + "</font>伤害", iGlobal.Global.battle);
                    iData.iPlayer.TitleList.updateTitleInfo("crit", 0, -1);
                }
            ...
            SkillDataList.behave_bolt = function (param1) {
                var _loc2_ = param1.skillData.setList;
                if (iPanel.iScene.MainScene.battle.playerMp < _loc2_[param1.level][2]) {
                    return false;
                }
                iPanel.iScene.MainScene.battle.playerMp = iPanel.iScene.MainScene.battle.playerMp - _loc2_[param1.level][2];
                var _loc3_ = iData.iSkill.SkillDataList.getCritMul();
                ...
                iPanel.iScene.MainScene.battle.monsterHp = iPanel.iScene.MainScene.battle.monsterHp - _loc5_;
            ...
            SkillDataList.traceAttackInfo = function (param1, param2, param3) {
                if (param3 > 1) {
                    iPanel.iScene.MainScene.allInfoPanel.addText("你使用了<font color=\'#ff4040\'>" + param1 + " </font>,对" + iData.iSkill.SkillDataList.monster.nameHtml + "造成了<font color=\'#ff4040\' size=\'20\'> " + param2 + "! </font>伤害.", iGlobal.Global.battle);
                    iData.iPlayer.TitleList.updateTitleInfo("crit", 0, 1);
                }
                else {
                    iPanel.iScene.MainScene.allInfoPanel.addText("你使用了<font color=\'#ff4040\'>" + param1 + " </font>,对" + iData.iSkill.SkillDataList.monster.nameHtml + "造成了<font color=\'#ff4040\'> " + param2 + "</font>伤害.", iGlobal.Global.battle);
                    iData.iPlayer.TitleList.updateTitleInfo("crit", 0, -1);
                }
            ...
            Object.defineProperty(SkillDataList, "monster", {
                get: function () {
                    return iPanel.iScene.MainScene.battle.monster;
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(SkillDataList, "CR", {
                get: function () {
                    return iPanel.iScene.MainScene.battle.CR;
                },
                enumerable: true,
                configurable: true
            });
...
//# sourceMappingURL=SkillDataList.js.map