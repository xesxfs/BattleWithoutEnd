    ...
    (function (iPet) {
        ...
        (function (iPetSkill) {
            var PetSkillList = (function () {
                ...
                PetSkillList.des_counterattack = function (param1) {
                ...
                PetSkillList.behave_ice_spear = function (param1) {
                    var _loc2_ = iData.iPet.iPetSkill.PetSkillList.getSetArray(param1);
                    if (iPanel.iScene.MainScene.battle.petMp < _loc2_[3]) {
                        return false;
                    }
                    iPanel.iScene.MainScene.battle.petMp = iPanel.iScene.MainScene.battle.petMp - _loc2_[3];
                ...
                PetSkillList.behave_fireball = function (param1) {
                    var _loc2_ = iData.iPet.iPetSkill.PetSkillList.getSetArray(param1);
                    if (iPanel.iScene.MainScene.battle.petMp < _loc2_[2]) {
                        return false;
                    }
                    iPanel.iScene.MainScene.battle.petMp = iPanel.iScene.MainScene.battle.petMp - _loc2_[2];
                    var _loc3_ = iData.iPet.iPetSkill.PetSkillList.getCritMul();
                    var _loc4_ = (_loc2_[0] + _loc2_[1] * iData.iPet.iPetSkill.PetSkillList.pet.level) * iData.iPet.iPetSkill.PetSkillList.pet.magicatt / 100 * iData.iPet.iPetSkill.PetSkillList.monsterPro;
                    if (_loc4_ < 1) {
                        _loc4_ = 1;
                ...
                PetSkillList.behave_thunder = function (param1) {
                    var _loc2_ = iData.iPet.iPetSkill.PetSkillList.getSetArray(param1);
                    if (iPanel.iScene.MainScene.battle.petMp < _loc2_[4]) {
                        return false;
                    }
                    iPanel.iScene.MainScene.battle.petMp = iPanel.iScene.MainScene.battle.petMp - _loc2_[4];
                    var _loc3_ = iData.iPet.iPetSkill.PetSkillList.getCritMul();
                    var _loc4_ = (_loc2_[0] + _loc2_[1] * iData.iPet.iPetSkill.PetSkillList.pet.level) * iData.iPet.iPetSkill.PetSkillList.pet.magicatt / 100 * iData.iPet.iPetSkill.PetSkillList.monsterPro;
                    if (_loc4_ < 1) {
                        _loc4_ = 1;
                ...
                PetSkillList.traceAttackInfo = function (param1, param2, param3) {
                    param2 = param2;
                    if (param3 > 1) {
                        iPanel.iScene.MainScene.allInfoPanel.addText("你的宠物使用了<font color=\'#ff4040\'>" + param1 + "</font>,对" + iData.iPet.iPetSkill.PetSkillList.monster.nameHtml + "造成了<font color=\'#ff4040\' size=\'20\'> " + param2 + "!</font>伤害.", iGlobal.Global.battle);
                    }
                    else {
                        iPanel.iScene.MainScene.allInfoPanel.addText("你的宠物使用了<font color=\'#ff4040\'>" + param1 + "</font>,对" + iData.iPet.iPetSkill.PetSkillList.monster.nameHtml + "造成了<font color=\'#ff4040\'> " + param2 + "</font>伤害.", iGlobal.Global.battle);
                    }
                };
                Object.defineProperty(PetSkillList, "pet", {
                    get: function () {
                        return iPanel.iScene.MainScene.battle.pet;
                    },
                    enumerable: true,
                    configurable: true
                });
...
//# sourceMappingURL=PetSkillList.js.map